...
if __name__ == '__main__':
    ...
    f = open('/media/discoGordo/dataset_leon/colmap_MICCAI/colmap_benckmark_MICCAI_inliers_H_saved.txt',"a+")
    ...
    for v in videos_seq:
        ...
        for seq in videos_seq[v]:
            ...
            for i in range(index_T1,len(images_number)-1):
                ...
                if images_number[index_T2] - image_number2 >= 0 and \
                        images_number[index_T2] - image_number2 <= 2:
                    ...
                    if len(kp1)>0 and len(kp2)>0:
                        ...
                        if len(matches)>0:
                            ...
                            inliers_H, inliers_E, inliers_Ef, inliers_Ec, R_E, R_E2, t_E = compute_inliers_3(
            ...
            #cv2.imwrite('/media/discoGordo/dataset_leon/colmap_MICCAI/inlier_heatmaps_GT/'+prefe+'_'+v+'_'+seq+'_'+img1_number+'_'+img2_number+'.png',(hist_Hv/hists)*255.)
        
    print(numberGood,numberBad)
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/newH/distanceFtoGT.npy",distanceFtoGT)
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/newH/distanceFtoF.npy",distanceFtoF)
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/newH/distanceGTtoGT.npy",distanceGTtoGT)
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/newH/numberGoodBad.npy",np.array([numberGood,numberBad]))
    below_th_q=[]
    below_th_t=[]
