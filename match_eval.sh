...
#python match_features_demo_MICCAI_UZ_video.py sift 1 40 --m /media/discoGordo/dataset_leon/UZ/masks/HCULB_1080_mask_eq.png --c 10 --ratio 80
...
#python match_features_demo_MICCAI_UZ_video.py orb 1 40 --m /media/discoGordo/dataset_leon/UZ/masks/HCULB_1080_mask_eq.png
...
#python match_features_demo_MICCAI_UZ_video.py pretrained/superpoint_v1.pth 1 40 --m /media/discoGordo/dataset_leon/UZ/masks/HCULB_1080_mask_eq.png
#python match_features_demo_MIDL2022_E.py superpoint_ucluzlabel100_specga_9-4_d3/checkpoints/superPointNet_200000_checkpoint.pth.tar 1 40 --m /media/discoGordo/dataset_leon/UZ/masks/HCULB_1080_mask_eq.png
