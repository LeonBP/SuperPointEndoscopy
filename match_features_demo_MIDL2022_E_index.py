...
if __name__ == '__main__':
    ...
    for v in videos_seq:
        ...
        for seq in videos_seq[v]:
            ...
            for i in range(index_T1,len(images_number)-1):
                ...
                indicesv.append(image_number1)
                indicesv.append(image_number2)
                index_T1+=1
                image_number1 = images_number[index_T1]
                continue
                '''else:
            ...
            indices[v][seq]=np.array(indicesv)
    ...
    np.save('/media/discoGordo/dataset_leon/colmap_MICCAI/'+'6indices1and2' + '_' + str(numberErrors) + '_' + img1_number + '_' + img2_number + '_' + str(window) + '.npy', indices)
    exit(1)
    if not spec and 'sift' not in weights_name:
        np.save('/media/discoGordo/dataset_leon/colmap_MICCAI/errors_public/6'+prefe+'_'+str(numberErrors)+'_'+img1_number+'_'+img2_number+'_'+str(window)+'.npy',err_qsdict)
        np.save('/media/discoGordo/dataset_leon/colmap_MICCAI/errors_t_public/6'+prefe+'_'+str(numberErrors)+'_'+img1_number+'_'+img2_number+'_'+str(window)+'.npy',err_tsdict)
    elif not spec:
