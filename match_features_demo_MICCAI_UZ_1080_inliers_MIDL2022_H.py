...
if __name__ == '__main__':
    ...
    if 'sift' in weights_name:
        ...
        prefe=weights_name[weights_name.rfind('specga'):]
    ...
    f = open('/media/discoGordo/dataset_leon/colmap_MIDL/colmap_benckmark_MIDL_inliers_H.txt','a+')
    ...
    for v in videos_seq:
        ...
        for seq in videos_seq[v]:
            ...
            #cv2.imwrite('/media/discoGordo/dataset_leon/colmap_MIDL/inlier_heatmaps_GT/'+prefe+'_'+v+'_'+seq+'_'+img1_number+'_'+img2_number+'.png',(hist_Hv/hists)*255.)
        
    print(numberGood,numberBad)
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/oldH/distanceFtoGT.npy",distanceFtoGT)
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/oldH/distanceFtoF.npy",distanceFtoF)
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/oldH/distanceGTtoGT.npy",distanceGTtoGT)
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/oldH/numberGoodBad.npy",np.array([numberGood,numberBad]))
    below_th_q=[]
    below_th_t=[]
