    ...
    for v in videos_seq:
        ...
        for seq in videos_seq[v]:
            ...
            for i in range(index_T1,len(images_number)-1):
                ...
                if abs(images_number[index_T2] - image_number2) == 0:
                    ...
                    if len(inliers_E)==len(matches):
                        matches_E = np.array(matches)[np.array(inliers_E).astype(bool)].tolist()
                    else:
                        matches_E = matches
                    matched_img = cv2.drawMatches(cv2.resize(img1_color, (256,256)), kp1_256,
                                                  ...
                                                  matches_E, None,
                                                  matchColor=(0, 255., 0.),
                                                  singlePointColor=(0., 0., 255.))#DRAW_RICH_KEYPOINTS )
