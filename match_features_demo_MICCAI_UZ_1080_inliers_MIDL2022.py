...
if __name__ == '__main__':
    ...
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/oldE/distanceFtoGT.npy",distanceFtoGT)
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/oldE/distanceFtoF.npy",distanceFtoF)
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/oldE/distanceGTtoGT.npy",distanceGTtoGT)
    #np.save("/media/discoGordo/dataset_leon/colmap_MICCAI/indexes/oldE/numberGoodBad.npy",np.array([numberGood,numberBad]))
    below_th_q=[]
    below_th_t=[]
